...
__version__ = run_path('src/log_queue_api/version.py')['__version__']
...
setup(
    ...
    version=__version__,
    author="David Kuda",
    author_email="david@kuda.ai",
    description="Process event like data",
    license="proprietary",
    url="",
    packages=find_packages("src"),
    package_dir={"": "src"},
    package_data={'log_queue_api': ['res/*']},
